...
const testFilePath = `${componentDir}/${componentName}.${testFilePrefix}.${fileExtension}`;
const typesFilePath = `${componentDir}/${componentName}.${typesFilePrefix}.ts`;
